    ...
    return (
        <main className="bg-white min-h-screen py-10 px-4">
            <div className="container mx-auto max-w-4xl">
                {/* Başlık */}
                <h1 className="text-4xl font-bold text-center text-[#02b3f9] mb-8">Online Otizm Danışma</h1>
                <p className="text-lg text-gray-700 text-center mb-10">
                    Online Otizm Danışma, ailelere ve öğretmenlere rehberlik ederek otizm spektrumundaki çocuklara özel
                    eğitim ve destek sağlar.
                </p>
                ...
                <section>
                    ...
                    <ul className="list-disc pl-6 text-gray-600 space-y-2">
                        ...
                        <li>
                            <strong>Kaynak Eksikliği:</strong> Öğretmenler ve aileler için uygun öğretim materyalleri
                            sağlar.
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Erişim Sorunları:</strong> Uzman desteğine ulaşamayan aileler için online
                            danışmanlık sunar.
                        </li>
                        <li>
                            <strong>Bireyselleştirilmiş Destek Eksikliği:</strong> Çocukların bireysel ihtiyaçlarına
                            uygun çözümler sunar.
                        </li>
                        <li>
                            <strong>Davranış Problemleri:</strong> Uygun davranış yönetimi stratejileriyle çocukların
                            sosyal uyumunu artırır.
                        </li>
                    </ul>
                </section>
            </div>
